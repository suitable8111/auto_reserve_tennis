...
################################################################################
## Form generated from reading UI file 'mainWindowxXthxc.ui'
##
...
class Ui_Auto(object):
    def setupUi(self, Auto):
        ...
        self.actionButton.setGeometry(QRect(500, 140, 100, 32))
        ...
        self.time_combo_box.setGeometry(QRect(420, 100, 181, 31))
        self.label_4 = QLabel(Auto)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(430, 80, 58, 16))
    ...
    def retranslateUi(self, Auto):
        ...
        self.sinea1_chk_box.setText(QCoreApplication.translate("Auto", u"\uc2e4\ub0b41", None))
        self.sinea2_chk_box.setText(QCoreApplication.translate("Auto", u"\uc2e4\ub0b42", None))
